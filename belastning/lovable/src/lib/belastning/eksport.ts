...
import type { Resultat, Stamdata, Tegningskalkule } from './typer';
import { SAMTIDIGHEDSFAKTORER, BYGGEPROGRAMKRAV, KABEL_TABEL, KONSTANTER, REFERENCEMAALINGER } from './data';
import { byggeXlsx, XLSX_STIL as S } from './xlsx';
